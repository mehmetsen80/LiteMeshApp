    ...
    public Mono<AuthResponse> login(LoginRequest request) {
        ...
        return Mono.just(request.getUsername())
            ...
            .switchIfEmpty(Mono.error(new ResourceNotFoundException(
                    String.format(ErrorCode.USER_NOT_FOUND.getDefaultMessage(), "username '" + request.getUsername() + "' does not exist")
            )))
            .flatMap(user -> {
                ...
                return Mono.error(new ResourceNotFoundException(
                        String.format(ErrorCode.USER_NOT_FOUND.getDefaultMessage(), "username '" + user.getUsername() + "' does not exist")
                ));
            })
